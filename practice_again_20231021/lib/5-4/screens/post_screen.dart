...
import 'package:practice_again_20231021/5-4/components/post_table.dart';
import 'package:practice_again_20231021/5-4/daos/post_dao.dart';
    ...
    return FutureBuilder<List<Post>>(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<Post>> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Scaffold(
            body: SingleChildScrollView(child: PostTable(snapshot.data!)),
          );
        }
      },
    );
